...
$proxyJob = Start-Process -FilePath "C:\Users\User\go\bin\bola.exe" -ArgumentList "proxy", "-c", "bola.yaml", "-q" -PassThru -NoNewWindow
...
Write-Host "[*] Sending simulated Owner Traffic..." -ForegroundColor Yellow
curl.exe -x "127.0.0.1:8888" -k -H "Cookie: $ownerCookie" "https://api.dashboard.magic.link/v1/magic_client/r85h34hQg16SegSbk_3I5zh4r7ZIvfl9hwSU5KvMToE=/users" -s -o NUL
Start-Sleep -Seconds 1

Write-Host "[*] Sending simulated Attacker Traffic..." -ForegroundColor Yellow
curl.exe -x "127.0.0.1:8888" -k -H "Cookie: $attackerCookie" "https://api.dashboard.magic.link/v1/magic_client/attacker_client_id/users" -s -o NUL
Start-Sleep -Seconds 1
